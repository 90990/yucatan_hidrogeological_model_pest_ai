...
def main():
    ...
    pars = read_params(root / "absolute_params1_caseC.csv")
    ...
    for layer in (0,1):
        plot_results(gwf, headfile, f"Caso C - Calibrado\nMalla triangular - Capa {int(layer)+1}", layer, root / f"tri_casoC_calibrado_layer{int(layer)+1}", "Cargas hidráulicas [m.s.n.m.]")
