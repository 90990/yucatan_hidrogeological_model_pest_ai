...
def _build_zone_masks_disu_disv(gwf, upland_cellids_0based: np.ndarray):
    ...
    zone_rest = ~(zone_upland)
    return zone_upland, zone_rest


def export_base_arrays_and_masks(gwf, template_dir: Path, zone_upland: np.ndarray, zone_rest: np.ndarray):
...
def main():
    ...
    zone_upland, zone_rest = _build_zone_masks_disu_disv(gwf, upland_cellids)

    export_base_arrays_and_masks(gwf, template_dir, zone_upland, zone_rest)
