...
def apply_parameters(gwf, pars: dict[str, float], root: Path) -> None:
    ...
    return k_upland_l1, k_upland_l2, k_rest_l1, k_rest_l2, r_upland, r_rest, mfgw
...
def main():
    ...
    k_upland_l1,k_upland_l2,k_rest_l1,k_rest_l2,r_upland,r_rest,mfgw = apply_parameters(gwf, pars, root)
    ...
    params_path = root / "absolute_params_caseC.csv"
