...
def main():
    ...
    shutil.copy2(root / "absolute_params1_caseD.csv", data_dir / "absolute_params1_caseD.csv")
    ...
    export_base_arrays_and_masks(gwf, data_dir, zone_ring, zone_upland, zone_rest)
