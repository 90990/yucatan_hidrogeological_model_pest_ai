...
def apply_parameters(gwf, pars: dict[str, float], root: Path) -> None:
    ...
    r_upland = 0.25*(mR_upland) 
    r_rest = 0.25*(mR_rest)

    fgw_upland = 0.3*(mFGW_upland)
    fgw_rest = 0.3*(mFGW_rest)
    ...
    return k_upland_l1, k_upland_l2, k_ring_l1, k_ring_l2, k_rest_l1, k_rest_l2, r_upland, r_rest, fgw_upland, fgw_rest
...
def main():
    ...
    k_upland_l1,k_upland_l2,k_ring_l1,k_ring_l2,k_rest_l1,k_rest_l2,r_upland,r_rest,fgw_upland, fgw_rest = apply_parameters(gwf, pars, root)
    ...
    params_path = root / "absolute_params1_caseD.csv"
