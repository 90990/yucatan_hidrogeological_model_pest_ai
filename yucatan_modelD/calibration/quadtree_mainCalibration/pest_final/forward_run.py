...
def main() -> None:
    ...
    pars = read_params(root / "absolute_params_caseD.csv")
    ...
    for layer in (0,1):
        plot_results(gwf, headfile, f"Cargas hidráulicas simuladas \n - Capa {int(layer)+1}", layer, root / f"quadtree_casoD_calibrado_layer{int(layer)+1}", "Cargas hidráulicas [m.s.n.m.]")
