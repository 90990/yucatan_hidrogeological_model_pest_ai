...
def main():
    ...
    ap.add_argument("--template_dir", default="template")
    args = ap.parse_args()
    ...
    write_sim_heads_ins(template_dir / "obs_heads.csv", template_dir / "sim_heads.ins")

    # Seed params.csv if missing
    params_path = template_dir / "params.csv"
