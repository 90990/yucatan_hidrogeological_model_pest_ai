...
def main() -> None:
    ...
    pars = read_params(root / "absolute_params_caseB.csv")
    ...
    for layer in (0,1):
        plot_results(gwf, headfile, f"Caso B - Calibrado\nMalla estructurada - Capa {int(layer)+1}", layer, root / f"estruc_casoB_calibrado_layer{int(layer)+1}", "Cargas hidráulicas [m.s.n.m.]")
